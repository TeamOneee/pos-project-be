...
describe('DashboardController', () => {
  ...
  it('GET /dashboard/summary mendelegasikan ke getSummary', async () => {
    ...
    const result = await controller.summary(makeActor(), periodQuery);

    expect(mockQuery.getSummary).toHaveBeenCalledWith(
  ...
  it('GET /dashboard/sales-trend mendelegasikan ke getSalesTrend', async () => {
    ...
    const result = await controller.salesTrend(
      makeActor(),
      trendQuery as never,
    );
  ...
  it('GET /dashboard/time-pattern mendelegasikan ke getTimePattern', async () => {
    ...
    const result = await controller.timePattern(makeActor(), periodQuery);
  ...
  it('GET /dashboard/top-products mendelegasikan ke getTopProducts', async () => {
    ...
    const result = await controller.topProducts(makeActor(), {
      ...periodQuery,
      limit: 5,
    });
  ...
  it('GET /dashboard/outlet-comparison mendelegasikan ke getOutletComparison', async () => {
    ...
    const result = await controller.outletComparison(makeActor(), periodQuery);
  ...
  it('GET /dashboard/operations mendelegasikan ke getOperations', async () => {
    ...
    const result = await controller.operations(makeActor(), {
      outlet_id: undefined,
    });
  ...
  it('GET /dashboard/low-stock mendelegasikan ke getLowStock', async () => {
    ...
    const result = await controller.lowStock(makeActor(), {
      outlet_id: undefined,
    });
